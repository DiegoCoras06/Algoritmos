...
class ListaEnlazada:
    ...
    def agregar_nodo(self, dato):
        ...
        if self.primero is None:
            ...
            self.ultimo = nuevo_nodo
    # Define el método insertar_nodo() que recibe el dato y la posición.
    def insertar_nodo(self, dato, posicion):
        # Crea un nuevo nodo con el dato pasado.
        nuevo_nodo = Nodo(dato)
        if posicion == 1:
            # El siguiente del nuevo apunta al primero actual.
    ...
    def imprimir_atras(self):
        ...
        # Inicia un ciclo while que se ejecutará mientras nodo_actual no sea None.
        while nodo_actual is not None:
            print(nodo_actual.dato)
